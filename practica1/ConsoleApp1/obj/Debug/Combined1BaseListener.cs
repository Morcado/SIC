...
public partial class Combined1BaseListener : ICombined1Listener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterExp([NotNull] Combined1Parser.ExpContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="Combined1Parser.exp"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitExp([NotNull] Combined1Parser.ExpContext context) { }
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterExp2([NotNull] Combined1Parser.Exp2Context context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="Combined1Parser.exp2"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitExp2([NotNull] Combined1Parser.Exp2Context context) { }
